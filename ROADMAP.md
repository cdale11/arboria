...
- [ ] [UI-02 through UI-10] Deliver the approved scene-first, detailed-stylized nursery UI, authoritative presentation state, suggested editable care, shop previews, truthful companion controls, backup/recovery, and real-browser desktop/phone acceptance. Partial UI-02 revision guard and frontend store are implemented; coherent server snapshot/stream/lifecycle contract remains open. Full specification and ordered dependencies: `docs/r1-ui-upgrade.md`.
