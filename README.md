...
**Authenticated living-nursery baseline with two ticking starter plants (greenhouse basil and outdoor oak from a six-species provisional catalog), root-zone water with finite reservoir watering, substrate N/P/K uptake with deficiency stress, damage, and death, shop economy with cash purchases and demand-limited plant sales, usable browser controls for inspection, care, shop, saves, clock, and plant sale protection, plus biology checkpoints. Procedural 2.5D rendering, fertilizer items, species calibration, companion behavior, export/import, and real touch-device validation have not been implemented yet.** The documents in this repository define intended behavior and delivery gates; they are not evidence that the described features work. See [ROADMAP.md](ROADMAP.md) for implementation status.
